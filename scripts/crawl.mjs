...
const run = async () => {
  ...
  // not an out-of-scope note (playbook §1).
  //   /google-my-business-walkthrough/  published page 241, orphaned: absent from
  //                                     the sitemap and unlinked from every page
  //   /category/uncategorized/          the one (empty) category archive, 200 on WP
  const extras = [
